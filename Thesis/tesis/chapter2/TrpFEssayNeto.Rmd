...
## PRA enzymatic assay
Fluorescence (black box) Excitation 310 emission 400 nm Anthranilic acid TECAN
```{r stock,echo=FALSE}
TrpC_stock=60 ##uM
TrpD_stock=40 ##uM
TrpF_stock=48.5 ##uM
...
Following table is an example with `r type` Scoe at `r TrpF_stock` when $`r  TrpF_vol` \mu l$ leads fo a final concentration of $`r TrpF_final` \mu M$ on $`r hole_vol` \mu l$    
