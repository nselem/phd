...
PlateColum=2
## 
GTP_stock=100000 ##100000nM-> 1000uM-> 1mM
```
...
GTPdata["Vol"] <-round(hole_vol*GTPdata["GTP_uM"]/(GTP_stock*10**(-1*GTPdata["GTP_Dilution"])),digits = 2) # That creates the new column named "MY_NEW_COLUMN" 

GTPdata["PriA_ul"]<-round(PriA,digits=2)
