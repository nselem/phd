...
PriA_final=1 ##uM = 800 nM final concentration on hole
...
AA_microMolar<-c(0,25,50,75,100,0,50,100)
...
ProFAR<-rep(4,8)  ## 
AAdata["Pro_uM"]<-c(50,50,50,50,50,50,50,50)
...
AAdata$BuffPRA <- Buffer/2
AAdata["BuffPro"] <- Buffer/2
