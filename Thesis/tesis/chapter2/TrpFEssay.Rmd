...
_Lysis Buffer_  
-Tris-HCL $pH 7.5$  $10mM$  (or Potassium phosphate $pH 7.5$ $10mM$)    
-EDTA  $pH 7.7$  
-NaCl  $50mM$
-Glycerol $5\%$   
-DTT  $0.1mM$(Fresh addition)  
-Mix protease inhibitor (Fresh addition)    
-Lysozyme $10\frac{mg}{ml}$ (Fresh addition)  
...
-$MgCl_2$ $2mM$  
-EDTA $0.5 mM$  
Following reaction buffer components must be added at the moment of essay and stocks must be prepared using as solvent the _TrpF reaction buffer_ previously described, NOT water. This precaution is to avoid alterations on reactives concentrations.  
  
-Anthranilic acid stock $1mM$ (this is the substrate that varies) store at $-20^{\circ}C$   
(Needs to be prepared but there is sigma dust available)  ¿PREGUNTA: cúanto volumen preparo de este?  
-PRPP stock $10mM$  ¿PREGUNTA: cúanto volumen preparo de este?  
(Final concentration must be always 5 times molar when compared with anthranilic acid) store at $-20^{\circ}C$  
-DTT stock $64mM$ (Final concentration 0.4 mM) store at $-20^{\circ}$  
¿PREGUNTA: cúanto volumen preparo de este?  
...
## Determination of cineticl parameters  
## Todo list
