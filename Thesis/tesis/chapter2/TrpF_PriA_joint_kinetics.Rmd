...
tablePRO <- read.table("15082017_praproAbsorbanceCombined.data",header=TRUE, sep="\t") 
tablePRA <- read.table("15082017_praproFluorescenceCombined.data",header=TRUE, sep="\t") 
