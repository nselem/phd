...
## Existe promiscuidad a nivel enzima, a nivel familia e inclusive a nivel cluster biosintético.  
Este trabajo aborda la promiscuidad enzimática a tres niveles: i) la promiscuidad de una enzima de un organismo en particular, ii) la promiscuidad de una familia de enzimas iii) y finalmente la promiscuidad de un cluster biosintético. Se discierne entre las preguntas ¿es esta familia promiscua?, ¿Dentro de esta familia promiscua, es la enzima perteneciente a  este organismo promiscua?, ¿Es este cluster biosintético promiscuo?. El primer problema consiste en ubicar cuáles familias enzimáticas tienen al menos una enzima promiscua, esta  es una propiedad de las familias. El segundo problema consiste en identifcar individualmente enzimas promiscuas en una familia promiscuas, esta es una propiedad de las enzimas  no de las familias. Y finalmente si entendemos un cluster biosintético como un conjunto de enzimas que reciben un sustrato, podemos generalizar la noción de promiscuidad.  
...
Para poder establecer diferencias en el número de copias debemos trabajar en la construcción de un marco filogenético consistente que permita ordenar inclusive organismos de la misma especie. Para ello pueden utilizarse el core genome el total de genes conservado de cada genoma en un grupo taxonómico. [@metaphor ]
