...
```{r Antecedentes conceptuales, results = "asis",message=FALSE, echo=FALSE}
...
<!--- Problema de promiscuidad, cuales familias son promiscuas -->


## No todos los elementos de una familia serán promiscuos. 
Este trabajo discierne entre diversas preguntas acerca de promiscuidad enzimática. Un primer problema consiste en ubicar cuáles familias enzimáticas tienen al menos una enzima promiscua, esta  es una propiedad de las familias. El segundo problema es que una vez identificada una familia con enzimas promiscuas esto no implica que todos sus miembros sean promiscuos por lo que queda pendiente un mecanismo para distinguir el nivel de promiscuidad de cada enzima, esta es una propiedad de las enzimas individuales. Se ha intentado identificar enzimas promiscuas, a nivel de secuencia, sin pasar por experimentacion mediante aprendizaje maquina. Estos enfoques son incapaces de identificar una familia promiscua si no se conoce previamente al menos un miembro promiscuo de ella. Por otra parte, en el problema de los miembros se presentan dificultades cuando la identidad de secuencia es alta, e.g. en la familia PriA-HisA se sabe que la enzima HisA de E. coli no es promiscua, pero PriA de Streptomyces coelicolor si lo es. 

<!--  medición promiscuidad nos quedamos genómica comparada medición estructural 
<! para la genómica -->  
...
<!--- Clasificacion taxonomica correcta  metaphor -->  
    
## El establecimiento de un marco de conservación permite distinguir cambios  
  
 <!---     Clasificación y variantes de enzimas acorde a su función -->
   
## La genómica comparativa como herramienta en la disticinción de miembros promiscuos    
...
<!---     Clasificación y variantes de clusters -->
