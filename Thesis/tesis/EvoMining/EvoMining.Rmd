...
```
  ...
  2) Family Number From evoMiningHeatmap  ##Fallo, pendiente HAcerlo con los.central
  Crear archivo vi Central.numbers
      1	Phosphoglycerate_dehydrogenase
      2	Phosphoserine_aminotransferase
      .
      .
      .
  ...
  5) AntiSMASH on sequences on tree  CYAN
   Ids antiSMASH file  cut -f2 Archeas_Smash |sort >Archeas_Smash_F1  
   ...
   output .smash
   ls *smash|sort -g |while read line; do wc $line; done
  ...
  7) Blue MiBig BLUE
   ls *Uniq|sort -g |while read line; do num=$(wc $line); echo $line $num; done
