...
```
  <!--
  1) Every BBH:
  perl GetBBH.pl vueltaArcheas.blast.bbh 
  output *.bbh
  
  2) Family Number From evoMiningHeatmap
  ...
  4) BBH on tree (first red colored)
  ...
  ls *Uniq|sort -g |while read line; do num=$(wc $line); echo $line $num; done
   ...
   7) Orange leaves (Central seeds/queries)
