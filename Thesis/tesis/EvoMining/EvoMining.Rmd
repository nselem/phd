...
### Section 1 EvoMining Updated model and pipeline   
...
### Figure 2  Update and insights from genomic databases   
  
Feature           EvoMining 1                   EvoMining 2  
--------------   ----------------------------   -------------------  
Genomic-DB     
                  Actinobacteria 230 genomes    Actinobacteria 1245 genomes                      
                                                Cyanobacteria 416 genomes       
                                                Archaea 876 genomes 
Central                                 
                  Actinobacteria 103 families   Actinobacteria 93 families                   
                                                Cyanobacteria  81 families      
                                                Archaea 80 families
Natural-DB                                                                                                    
                  Manual curation   MiBIG
Code                                                                 
                  Consulting web site           Standalone tool
...
#### 2a Lineage specific  
![Pipeline](Figuras/GenomicDBS.svg)    
...
## 3 Update and insights from central DB
## 4 Update and insights from Natural products DB
Backward EvoMining  
