...
% Everything below added by CII
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \KeywordTok{label}\NormalTok{(}\DataTypeTok{path =} \StringTok{"chapter3/Archeasexpansion_plot.pdf"}\NormalTok{, }\DataTypeTok{caption =} \StringTok{"Archeas expansions Boxplot"}\NormalTok{,}\DataTypeTok{label =} \StringTok{"Archeas_expansion_boxplot"}\NormalTok{, }\DataTypeTok{type =} \StringTok{"figure"}\NormalTok{)}
  \end{Highlighting}
  \end{Shaded}
  
  \begin{figure}[h!tbp]
  \centering
  \includegraphics[angle = 0,scale = 1]{chapter3/Archeasexpansion_plot.pdf}
  \caption[Archeas expansions Boxplot]{\normalsize{Archeas expansions Boxplot}}
  \label{fig:Archeas_expansion_boxplot}
  \end{figure}
  
  Here is a reference to the expansion boxplot:
  \autoref{fig:Archeas_expansion_boxplot}.\\
  \clearpage 
