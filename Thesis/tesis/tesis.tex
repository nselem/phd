...
% Everything below added by CII
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \KeywordTok{label}\NormalTok{(}\DataTypeTok{path =} \StringTok{"chapter5/HeatPlot.pdf"}\NormalTok{, }\DataTypeTok{caption =} \StringTok{"Cyanobacterial Heatplot"}\NormalTok{,}\DataTypeTok{label =} \StringTok{"CyanoPlot"}\NormalTok{, }\DataTypeTok{type =} \StringTok{"figure"}\NormalTok{)}
  \end{Highlighting}
  \end{Shaded}
  ...
  Here is a reference to the Reed logo: \autoref{fig:CyanoPlot}.
