...
% Everything below added by CII
  ...
  \begin{figure}[h!tbp]
  \centering
  \includegraphics[angle = 0,scale = 0.6]{chapter4/HeatPlotActinos.pdf}
  \caption[Actinobacterial Heatplot]{\normalsize{Actinobacterial Heatplot}}
  \label{fig:ActinoPlot}
  \end{figure}
  
  \chapter{\texorpdfstring{Here is a reference to the HeatPlot:
  \autoref{fig:ActinoPlot}.}{Here is a reference to the HeatPlot: .}}\label{here-is-a-reference-to-the-heatplot-.}
