...
% Everything below added by CII
  ...
  \NormalTok{\}}
  \NormalTok{small[ }\OperatorTok{!}\NormalTok{small}\OperatorTok{$}\NormalTok{variable }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Contigs"}\NormalTok{, }\StringTok{"Size"}\NormalTok{,}\StringTok{"TOTAL"}\NormalTok{), ] }
  \end{Highlighting}
  \end{Shaded}
  ...
  * BBH Best Bidirectional Hits with studied enzymes from Central
  ...
  \NormalTok{MetFam_BP.m=ArchaeasHeatPlotBP.m[ArchaeasHeatPlotBP.m}\OperatorTok{$}\NormalTok{variable }\OperatorTok{%in%}\StringTok{ }\NormalTok{MetFam}\OperatorTok{$}\NormalTok{Enzyme,]}
  ...
  \begin{figure}[h!tbp]
  \centering
  \includegraphics[angle = 0,scale = 1]{chapter3/figura5.pdf}
  \caption[EvoMining Algorithm]{\normalsize{EvoMining Algorithm}}
  \label{fig:EvoMining Algorithms}
  \end{figure}
