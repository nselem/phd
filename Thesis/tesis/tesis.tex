...
% Everything below added by CII
  ...
  Henn {[}\protect\hyperlink{ref-henn-sax_two_2002}{165}{]}\strut
  \end{minipage}\tabularnewline
  \begin{minipage}[t]{0.15\columnwidth}\raggedright\strut
  \emph{Escherichia coli}\strut
  \end{minipage} & \begin{minipage}[t]{0.05\columnwidth}\raggedright\strut
  ...
  \end{minipage} & \begin{minipage}[t]{0.11\columnwidth}\raggedright\strut
  Sterner
  {[}\protect\hyperlink{ref-sterner_phosphoribosyl_1996}{166}{]}\strut
  \end{minipage}\tabularnewline
  \begin{minipage}[t]{0.15\columnwidth}\raggedright\strut
  ...
  *\strut
  ...
  0.17\strut
  \end{minipage} & \begin{minipage}[t]{0.11\columnwidth}\raggedright\strut
  Due {[}\protect\hyperlink{ref-due_bisubstrate_2011}{167}{]}\strut
  \end{minipage}\tabularnewline
  \begin{minipage}[t]{0.15\columnwidth}\raggedright\strut
  ...
  *\strut
  ...
  \end{minipage} & \begin{minipage}[t]{0.11\columnwidth}\raggedright\strut
  Noda
  {[}\protect\hyperlink{ref-noda-garcia_identification_2010}{168}{]}\strut
  \end{minipage}\tabularnewline
  \begin{minipage}[t]{0.15\columnwidth}\raggedright\strut
  \emph{Streptomyces coelicolor}\strut
  \end{minipage} & \begin{minipage}[t]{0.05\columnwidth}\raggedright\strut
  ...
  *\strut
  ...
  están localizadas cerca de saxitoxin, la HisA marcada como BGC de
  Cyanobacteria. En \emph{Pseudomonas} hay una gran población de
  predicciones de EvoMining, pero son falsos positivios, ya que estas no
  ...
  {[}\protect\hyperlink{ref-gao_biosynthesis_2017}{169}{]}. La
  ...
  celulosa {[}\protect\hyperlink{ref-chertkov_complete_2011}{170}{]}.
  ...
  {[}\protect\hyperlink{ref-pukall_complete_2009}{171}{]}.
  ...
  \NormalTok{tablePRO}\OperatorTok{$}\NormalTok{Temp<-}\OtherTok{NULL}
  \NormalTok{tablePRO}\OperatorTok{$}\NormalTok{Cycle<-}\OtherTok{NULL}
  
  \NormalTok{a<-tablePRO}\OperatorTok{$}\NormalTok{Time[}\KeywordTok{c}\NormalTok{(}\OtherTok{TRUE}\NormalTok{,}\OtherTok{FALSE}\NormalTok{)]}
  \NormalTok{b<-tablePRO}\OperatorTok{$}\NormalTok{Time[}\KeywordTok{c}\NormalTok{(}\OtherTok{TRUE}\NormalTok{,}\OtherTok{FALSE}\NormalTok{)]}\OperatorTok{+}\FloatTok{19.15}
  
  \NormalTok{tablePRO}\OperatorTok{$}\NormalTok{Time[}\KeywordTok{c}\NormalTok{(}\OtherTok{TRUE}\NormalTok{, }\OtherTok{FALSE}\NormalTok{)] <-}\StringTok{ }\NormalTok{a}
  \NormalTok{tablePRO}\OperatorTok{$}\NormalTok{Time[}\KeywordTok{c}\NormalTok{(}\OtherTok{FALSE}\NormalTok{, }\OtherTok{TRUE}\NormalTok{)] <-}\StringTok{ }\NormalTok{b}
  \NormalTok{tablePRO}\OperatorTok{$}\NormalTok{Time}
  \end{Highlighting}
  \end{Shaded}
  ...
  \KeywordTok{plot}\NormalTok{(PROassay.m}\OperatorTok{$}\NormalTok{Time, PROassay.m}\OperatorTok{$}\NormalTok{value, }\DataTypeTok{col=}\NormalTok{PROassay.m}\OperatorTok{$}\NormalTok{variable,  }\DataTypeTok{xlab=}\StringTok{"Time [s]"}\NormalTok{,}\DataTypeTok{ylab=}\StringTok{"Absorbance"}\NormalTok{, }\DataTypeTok{pch=}\DecValTok{19}\NormalTok{,}\DataTypeTok{bty=}\StringTok{'L'}\NormalTok{)}
  \KeywordTok{par}\NormalTok{(}\DataTypeTok{xpd =} \OtherTok{TRUE}\NormalTok{)}
  \KeywordTok{legend}\NormalTok{(}\StringTok{"right"}\NormalTok{, }\DataTypeTok{legend =}\NormalTok{ (}\KeywordTok{unique}\NormalTok{(PROassay.m}\OperatorTok{$}\NormalTok{variable)), }\DataTypeTok{col =}\NormalTok{ (}\KeywordTok{unique}\NormalTok{(PROassay.m}\OperatorTok{$}\NormalTok{variable)),}\DataTypeTok{pch=}\DecValTok{19}\NormalTok{,}\DataTypeTok{bg=}\StringTok{"white"}\NormalTok{)}
  \end{Highlighting}
  \end{Shaded}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \KeywordTok{ggplot}\NormalTok{(PROassay.m, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ PROassay.m}\OperatorTok{$}\NormalTok{Time, }\DataTypeTok{y =}\NormalTok{ PROassay.m}\OperatorTok{$}\NormalTok{value),}\DataTypeTok{color=}\StringTok{"variable"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_bw}\NormalTok{() }
  \end{Highlighting}
  \end{Shaded}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \KeywordTok{qplot}\NormalTok{(Time,value, }\DataTypeTok{data =}\NormalTok{ PROassay.m,}\DataTypeTok{colour=}\NormalTok{variable)}\OperatorTok{+}\KeywordTok{theme_bw}\NormalTok{()}\OperatorTok{+}\StringTok{ }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position  =}\StringTok{"bottom"}\NormalTok{,}\DataTypeTok{legend.text=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{10}\NormalTok{),}\DataTypeTok{plot.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{14}\NormalTok{, }\DataTypeTok{face =} \StringTok{"bold"}\NormalTok{),}\DataTypeTok{text =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{12}\NormalTok{),}\DataTypeTok{axis.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{face=}\StringTok{"bold"}\NormalTok{),}\DataTypeTok{axis.text.x=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{10}\NormalTok{),}\DataTypeTok{axis.text.y=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{7}\NormalTok{))}\OperatorTok{+}\KeywordTok{facet_grid}\NormalTok{(PROassay.m}\OperatorTok{$}\NormalTok{variable}\OperatorTok{~}\NormalTok{.,}\DataTypeTok{scales=}\StringTok{"free"}\NormalTok{)}
  \end{Highlighting}
  \end{Shaded}
  ...
  \begin{Highlighting}[]
  \NormalTok{## visualising full data}
  \NormalTok{tablePRA}\OperatorTok{$}\NormalTok{Temp<-}\OtherTok{NULL}
  \NormalTok{tablePRA}\OperatorTok{$}\NormalTok{Cycle<-}\OtherTok{NULL}
  
  \NormalTok{a<-tablePRA}\OperatorTok{$}\NormalTok{Time[}\KeywordTok{c}\NormalTok{(}\OtherTok{TRUE}\NormalTok{,}\OtherTok{FALSE}\NormalTok{)]}
  \NormalTok{b<-tablePRA}\OperatorTok{$}\NormalTok{Time[}\KeywordTok{c}\NormalTok{(}\OtherTok{TRUE}\NormalTok{,}\OtherTok{FALSE}\NormalTok{)]}\OperatorTok{+}\FloatTok{19.15}
  
  \NormalTok{tablePRA}\OperatorTok{$}\NormalTok{Time[}\KeywordTok{c}\NormalTok{(}\OtherTok{TRUE}\NormalTok{, }\OtherTok{FALSE}\NormalTok{)] <-}\StringTok{ }\NormalTok{a}
  \NormalTok{tablePRA}\OperatorTok{$}\NormalTok{Time[}\KeywordTok{c}\NormalTok{(}\OtherTok{FALSE}\NormalTok{, }\OtherTok{TRUE}\NormalTok{)] <-}\StringTok{ }\NormalTok{b}
  \NormalTok{tablePRA}\OperatorTok{$}\NormalTok{Time}
  \end{Highlighting}
  \end{Shaded}
  ...
  \KeywordTok{plot}\NormalTok{(PRAassay.m}\OperatorTok{$}\NormalTok{Time, PRAassay.m}\OperatorTok{$}\NormalTok{value, }\DataTypeTok{col=}\NormalTok{PRAassay.m}\OperatorTok{$}\NormalTok{variable,  }\DataTypeTok{xlab=}\StringTok{"Time [s]"}\NormalTok{,}\DataTypeTok{ylab=}\StringTok{"Fluorescence"}\NormalTok{, }\DataTypeTok{pch=}\DecValTok{19}\NormalTok{,}\DataTypeTok{bty=}\StringTok{'L'}\NormalTok{)}
  \KeywordTok{par}\NormalTok{(}\DataTypeTok{xpd =} \OtherTok{TRUE}\NormalTok{)}
  \KeywordTok{legend}\NormalTok{(}\StringTok{"right"}\NormalTok{, }\DataTypeTok{legend =}\NormalTok{ (}\KeywordTok{unique}\NormalTok{(PRAassay.m}\OperatorTok{$}\NormalTok{variable)), }\DataTypeTok{col =}\NormalTok{ (}\KeywordTok{unique}\NormalTok{(PRAassay.m}\OperatorTok{$}\NormalTok{variable)),}\DataTypeTok{pch=}\DecValTok{19}\NormalTok{,}\DataTypeTok{bg=}\StringTok{"white"}\NormalTok{)}
  \end{Highlighting}
  \end{Shaded}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \KeywordTok{ggplot}\NormalTok{(PRAassay.m, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ PRAassay.m}\OperatorTok{$}\NormalTok{Time, }\DataTypeTok{y =}\NormalTok{ PRAassay.m}\OperatorTok{$}\NormalTok{value),}\DataTypeTok{color=}\StringTok{"variable"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_bw}\NormalTok{() }
  \end{Highlighting}
  \end{Shaded}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \KeywordTok{qplot}\NormalTok{(Time,value, }\DataTypeTok{data =}\NormalTok{ PRAassay.m,}\DataTypeTok{colour=}\NormalTok{variable)}\OperatorTok{+}\KeywordTok{theme_bw}\NormalTok{()}\OperatorTok{+}\StringTok{ }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position  =}\StringTok{"bottom"}\NormalTok{,}\DataTypeTok{legend.text=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{10}\NormalTok{),}\DataTypeTok{plot.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{14}\NormalTok{, }\DataTypeTok{face =} \StringTok{"bold"}\NormalTok{),}\DataTypeTok{text =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{12}\NormalTok{),}\DataTypeTok{axis.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{face=}\StringTok{"bold"}\NormalTok{),}\DataTypeTok{axis.text.x=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{10}\NormalTok{),}\DataTypeTok{axis.text.y=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{7}\NormalTok{))}\OperatorTok{+}\KeywordTok{facet_grid}\NormalTok{(PRAassay.m}\OperatorTok{$}\NormalTok{variable}\OperatorTok{~}\NormalTok{.,}\DataTypeTok{scales=}\StringTok{"free"}\NormalTok{)}
  \end{Highlighting}
  \end{Shaded}
  ...
  \NormalTok{PRAassay2Time<-tablePRA[}\KeywordTok{which}\NormalTok{(tablePRA}\OperatorTok{$}\NormalTok{Time }\OperatorTok{>=}\StringTok{ }\NormalTok{cuttime }\OperatorTok{&}\StringTok{ }\NormalTok{tablePRA}\OperatorTok{$}\NormalTok{Time }\OperatorTok{<=}\StringTok{ }\NormalTok{maxtime),]}
  ...
  \NormalTok{V0 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(PRAassay2Time, }\DecValTok{2}\NormalTok{, }\ControlFlowTok{function}\NormalTok{(x) }\KeywordTok{coefficients}\NormalTok{(}\KeywordTok{lm}\NormalTok{(x }\OperatorTok{~}\StringTok{ }\NormalTok{PRAassay2Time}\OperatorTok{$}\NormalTok{Time,}\DataTypeTok{na.action=}\NormalTok{na.omit))[}\DecValTok{2}\NormalTok{])}
  
  \NormalTok{PRAassay2Time.m <-}\StringTok{ }\KeywordTok{melt}\NormalTok{(PRAassay2Time,}\DataTypeTok{id=}\StringTok{"Time"}\NormalTok{)}
  \KeywordTok{plot}\NormalTok{(PRAassay2Time.m}\OperatorTok{$}\NormalTok{Time, PRAassay2Time.m}\OperatorTok{$}\NormalTok{value, }\DataTypeTok{col=}\NormalTok{PRAassay2Time.m}\OperatorTok{$}\NormalTok{variable,}\DataTypeTok{xlab=}\StringTok{"Time"}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{"URF PRA uM"}\NormalTok{, }\DataTypeTok{pch=}\DecValTok{19}\NormalTok{, }\DataTypeTok{xlim=}\KeywordTok{c}\NormalTok{(cuttime}\OperatorTok{-}\DecValTok{50}\NormalTok{,maxtime}\OperatorTok{+}\DecValTok{50}\NormalTok{),}\DataTypeTok{bty=}\StringTok{'L'}\NormalTok{)}
  
  \NormalTok{V1 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(PRAassay2Time[,}\DecValTok{2}\OperatorTok{:}\KeywordTok{ncol}\NormalTok{(PRAassay2Time)], }\DecValTok{2}\NormalTok{, }\ControlFlowTok{function}\NormalTok{(x) }\KeywordTok{coefficients}\NormalTok{(}\KeywordTok{lm}\NormalTok{(x }\OperatorTok{~}\StringTok{ }\NormalTok{PRAassay2Time}\OperatorTok{$}\NormalTok{Time,}\DataTypeTok{na.action=}\NormalTok{na.omit)))}
  \KeywordTok{apply}\NormalTok{(V1, }\DecValTok{2}\NormalTok{, }\ControlFlowTok{function}\NormalTok{(x) \{}\KeywordTok{abline}\NormalTok{(x, }\DataTypeTok{col =}\NormalTok{ PRAassay2Time.m}\OperatorTok{$}\NormalTok{variable)  \})}
  \end{Highlighting}
  \end{Shaded}
  ...
  \NormalTok{slopeText<-}\KeywordTok{paste}\NormalTok{(slopeText2,}\KeywordTok{rev}\NormalTok{(}\KeywordTok{round}\NormalTok{(V0[}\OperatorTok{-}\DecValTok{1}\NormalTok{],}\DataTypeTok{digits=}\DecValTok{6}\NormalTok{)),}\KeywordTok{rev}\NormalTok{(}\KeywordTok{names}\NormalTok{(V0[}\OperatorTok{-}\DecValTok{1}\NormalTok{])))}
  ...
  \NormalTok{slopes=(}\KeywordTok{round}\NormalTok{(V0[}\OperatorTok{-}\DecValTok{1}\NormalTok{],}\DataTypeTok{digits=}\DecValTok{6}\NormalTok{))[}\KeywordTok{c}\NormalTok{(}\OtherTok{TRUE}\NormalTok{)]}
  ...
  \NormalTok{slopes=}\KeywordTok{as.matrix}\NormalTok{((}\KeywordTok{round}\NormalTok{(V0[}\OperatorTok{-}\DecValTok{1}\NormalTok{],}\DataTypeTok{digits=}\DecValTok{6}\NormalTok{))[}\KeywordTok{c}\NormalTok{(}\OtherTok{TRUE}\NormalTok{)])}
  ...
  \NormalTok{v<-}\OperatorTok{-}\DecValTok{1}\OperatorTok{*}\NormalTok{v}
  \NormalTok{S_ProFAR}
  \NormalTok{v}
  \NormalTok{mm <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(S_ProFAR,v)                                                                                 }
  \NormalTok{model.drm <-}\StringTok{ }\KeywordTok{drm}\NormalTok{(v }\OperatorTok{~}\StringTok{ }\NormalTok{S, }\DataTypeTok{data =}\NormalTok{ mm, }\DataTypeTok{fct =} \KeywordTok{MM.2}\NormalTok{())}
  ...
  \NormalTok{Vmax=}\DecValTok{2}\OperatorTok{*}\KeywordTok{coefficients}\NormalTok{(model.drm)[}\DecValTok{2}\NormalTok{]}
  \NormalTok{Enzyme=}\FloatTok{2.5} \CommentTok{#2.5uM}
  \NormalTok{Kcat=Vmax}\OperatorTok{*}\NormalTok{Enzyme  }
  \NormalTok{Km}
  \NormalTok{Vmax}
  \NormalTok{Kcat}
  \NormalTok{mml <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{S =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(mm}\OperatorTok{$}\NormalTok{S), }\DataTypeTok{length.out =} \DecValTok{100}\NormalTok{))}
  \NormalTok{mml}\OperatorTok{$}\NormalTok{v <-}\StringTok{ }\KeywordTok{predict}\NormalTok{(model.drm, }\DataTypeTok{newdata =}\NormalTok{ mml)}
  
  
  \NormalTok{## plot on r base}
  \KeywordTok{plot}\NormalTok{(mm,}\DataTypeTok{log=}\StringTok{''}\NormalTok{,}\DataTypeTok{xlim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\KeywordTok{max}\NormalTok{(mm}\OperatorTok{$}\NormalTok{S)), }\DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\KeywordTok{max}\NormalTok{(mm}\OperatorTok{$}\NormalTok{v)), }\DataTypeTok{xlab=}\StringTok{"Reads"}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{"Transcripts"}\NormalTok{)}
  
  \NormalTok{##plot on ggplot}
  \KeywordTok{ggplot}\NormalTok{(mm, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ S, }\DataTypeTok{y =}\NormalTok{ v)) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_bw}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Concentration [uM]"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Speed [d[PRA]uM/s]"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Michaelis-Menten kinetics"}\NormalTok{) }\OperatorTok{+}\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ mml, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ S, }\DataTypeTok{y =}\NormalTok{ v), }\DataTypeTok{colour =} \StringTok{"red"}\NormalTok{)}
  ...
  169. Gao Y, Xu G, Wu P, Liu J, Cai Y-s, Deng Z, et al. Biosynthesis of
  ...
  170. Chertkov O, Sikorski J, Nolan M, Lapidus A, Lucas S, Del Rio TG, et
  ...
  171. Pukall R, Gehrich-Schröter G, Lapidus A, Nolan M, Glavina Del Rio
  ...
  172. Angel E. Interactive computer graphics : A top-down approach with
  opengl. Boston, MA: Addison Wesley Longman; 2000.
  
  \hypertarget{ref-angel2001}{}
  173. Angel E. Batch-file computer graphics : A bottom-up approach with
  quicktime. Boston, MA: Wesley Addison Longman; 2001.
  
  \hypertarget{ref-angel2002a}{}
  174. Angel E. Test second book by angel. Boston, MA: Wesley Addison
  Longman; 2001.
