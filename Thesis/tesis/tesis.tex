...
% Everything below added by CII
  ...
  \section{No todos los elementos de una familia serán
  promiscuos.}\label{no-todos-los-elementos-de-una-familia-seran-promiscuos.}
  
  Este trabajo discierne entre diversas preguntas acerca de promiscuidad
  enzimática. Un primer problema consiste en ubicar cuáles familias
  enzimáticas tienen al menos una enzima promiscua, esta es una propiedad
  de las familias. El segundo problema es que una vez identificada una
  familia con enzimas promiscuas esto no implica que todos sus miembros
  sean promiscuos por lo que queda pendiente un mecanismo para distinguir
  el nivel de promiscuidad de cada enzima, esta es una propiedad de las
  enzimas individuales. Se ha intentado identificar enzimas promiscuas, a
  nivel de secuencia, sin pasar por experimentacion mediante aprendizaje
  maquina. Estos enfoques son incapaces de identificar una familia
  promiscua si no se conoce previamente al menos un miembro promiscuo de
  ella. Por otra parte, en el problema de los miembros se presentan
  dificultades cuando la identidad de secuencia es alta, e.g.~en la
  familia PriA-HisA se sabe que la enzima HisA de E. coli no es promiscua,
  pero PriA de Streptomyces coelicolor si lo es.
  ...
  Para distinguir cambios primero se tiene que establecer un marco de
  conservación.
  
  \section{La genómica comparativa como herramienta en la disticinción de
  miembros
  promiscuos}\label{la-genomica-comparativa-como-herramienta-en-la-disticincion-de-miembros-promiscuos}
  ...
  * BBH Best Bidirectional Hits with studied enzymes from Central
  ...
  {[}\protect\hyperlink{ref-moustafa_origin_2009}{91}{]}.\\
  PriA\\
  PriB\\
  SubHisA\\
  subTrpF\\
  ...
  77. Petrenko R, Meller J. Molecular Dynamics. In: eLS {[}Internet{]}.
  ...
  81. Bisswanger H. General Aspects of Enzyme Analysis. In: Practical
  ...
  127. Cohen GN. The biosynthesis of histidine and its regulation. In:
