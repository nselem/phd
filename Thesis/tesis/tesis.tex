...
% Everything below added by CII
  ...
  * BBH Best Bidirectional Hits with studied enzymes from Central
  ...
  \begin{figure}[h!tbp]
  \centering
  \includegraphics[angle = 0,scale = 0.6]{chapter2/MutantControl.png}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \NormalTok{GTP <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}\StringTok{"chapter2/GTP.activity"}\NormalTok{, }\DataTypeTok{header=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{sep=}\StringTok{"}\CharTok{\textbackslash{}t}\StringTok{"}\NormalTok{)}
  \NormalTok{dGTP <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}\StringTok{"chapter2/dGTP.activity"}\NormalTok{, }\DataTypeTok{header=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{sep=}\StringTok{"}\CharTok{\textbackslash{}t}\StringTok{"}\NormalTok{)}
  ...
  \begin{figure}[h!tbp]
  \centering
  \includegraphics[angle = 0,scale = 0.6]{chapter2/Geles/PriAAbril30.png}
  \caption[gel]{\normalsize{gel}}
  \label{fig:gel}
  \end{figure}
