...
% Everything below added by CII
  ...
  variación divide a la familia en varias subfamilias según su
  funcionalidad. En la tabla \autoref{tab:cineticos} se muestra la
  capacidad de catálisis PriA en diferentes organismos para sus dos
  sustratos conocidos. Estos datos ejemplifican las subfamilias de PriA,
  en la tabla se encuentran por ejemplo miembros de PriB, una subfamilia
  con presencia en el género \emph{Streptomyces}. PriB muestra poca
  actividad \emph{trpF} . Varios \emph{Streptomyces} con un elmento de
  PriB, contienen en su genoma un gen \emph{trpF} localizado fuera del
  contexto genómico cerccano operón de histidina. Otra subfamilia es
  subHisA con miembros en \emph{Corynebacteria} y \emph{Actinomyces}.
  SubHisA ha perdido totalmente la actividad \emph{trpF}. Finalmente en
  Actinomyces encontramos hay \emph{subTrpF} que ha perdido su actividad
  de HisA.
  
  En este capítulo se explora la distribución de PriA en diversos linajes
  genómicos utilizando EvoMining y CORASON. Como resultado se encuentran
  ...
  catalítica sobre ambas reacciones.
  ...
  *\strut
  ...
  En Actinobacteria, se observó que todos los Streptomyces tienen el
  cluster de PriA parcialmente conservado con respecto al BGC de
  \emph{Streptomyces coelicolor}. El único organismo de este género con
  una copia extra es \emph{Streptomyces} CT34. La copia parece deberse a
  transferencia horizontal pues su hit en NCBI proviene de una
  \emph{Lentzea}. Este fue sin embargo un homólogo lejano ya que tuvo 50\%
  de identidad y 98\% de cobertura. Otro caso interesante en
  Actinobacteria es XXXX
  
  No es el caso de Cyanobacteria. Copia doble Oscillatoriales
  cyanobacterium MTP1
  ...
  En esta sección analizamos cómo cambia la capacidad catalitica de un
  sustrato mientras se transforma la del otro. Para ello se utilizaron
  datos de la TESIS de LIA de mutantes puntuales. Se obtuvieron todas las
  trayectorias empezando con mutantes simples hasta la mutante con 11
  cambios. Como resultado No existieron rutas darwininanas. Finalmente,
  estos aminoácidos fueron comparados con los provistos por EVCouplings,
  de covariación.
  ...
  {[}\protect\hyperlink{ref-chertkov_complete_2011}{166}{]}.
  ...
  {[}\protect\hyperlink{ref-pukall_complete_2009}{167}{]}.
  ...
  \section{El análisis de PriA a nivel estructural sugiere que GTP es el
  sustrato más
  ...
  \subsection{Similar substrates to PRA and PROFAR suggested by Tanimoto
  ...
  \subsection{Docking between PriA enzymes and selected
  ...
  166. Chertkov O, Sikorski J, Nolan M, Lapidus A, Lucas S, Del Rio TG, et
  ...
  167. Pukall R, Gehrich-Schröter G, Lapidus A, Nolan M, Glavina Del Rio
  ...
  168. Angel E. Interactive computer graphics : A top-down approach with
  opengl. Boston, MA: Addison Wesley Longman; 2000.
  
  \hypertarget{ref-angel2001}{}
  169. Angel E. Batch-file computer graphics : A bottom-up approach with
  quicktime. Boston, MA: Wesley Addison Longman; 2001.
  
  \hypertarget{ref-angel2002a}{}
  170. Angel E. Test second book by angel. Boston, MA: Wesley Addison
  Longman; 2001.
