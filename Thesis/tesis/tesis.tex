...
% Everything below added by CII
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \NormalTok{ArchaeasCentral <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}\StringTok{"chapter3/ArchaeasCentral"}\NormalTok{, }\DataTypeTok{header=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{sep=}\StringTok{"}\CharTok{\textbackslash{}t}\StringTok{"}\NormalTok{)}
  ...
  \NormalTok{ArchaeasNp <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}\StringTok{"chapter3/ArchaeasNp"}\NormalTok{, }\DataTypeTok{header=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{sep=}\StringTok{"}\CharTok{\textbackslash{}t}\StringTok{"}\NormalTok{)}
  \NormalTok{ArchaeasSMASH <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}\StringTok{"chapter3/ArchaeasSMASH"}\NormalTok{, }\DataTypeTok{header=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{sep=}\StringTok{"}\CharTok{\textbackslash{}t}\StringTok{"}\NormalTok{)}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \NormalTok{ActinoCentral <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}\StringTok{"chapter4/ActinoCentral"}\NormalTok{, }\DataTypeTok{header=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{sep=}\StringTok{"}\CharTok{\textbackslash{}t}\StringTok{"}\NormalTok{)}
  \NormalTok{ActinoHeatPlot <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}\StringTok{"chapter4/ActinoHeatPlot"}\NormalTok{, }\DataTypeTok{header=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{sep=}\StringTok{"}\CharTok{\textbackslash{}t}\StringTok{"}\NormalTok{)}
  \NormalTok{ActinoNp <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}\StringTok{"chapter4/ActinoNp"}\NormalTok{, }\DataTypeTok{header=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{sep=}\StringTok{"}\CharTok{\textbackslash{}t}\StringTok{"}\NormalTok{)}
  \NormalTok{ActinosSmashResults <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}\StringTok{"chapter4/ActinosSmashResults"}\NormalTok{, }\DataTypeTok{header=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{sep=}\StringTok{"}\CharTok{\textbackslash{}t}\StringTok{"}\NormalTok{)}
  \NormalTok{ActinoTaxa <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}\StringTok{"chapter4/ActinoTaxa"}\NormalTok{, }\DataTypeTok{header=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{sep=}\StringTok{"}\CharTok{\textbackslash{}t}\StringTok{"}\NormalTok{)}
  \end{Highlighting}
  \end{Shaded}
  ...
  \begin{figure}[h!tbp]
  \centering
  \includegraphics[angle = 0,scale = 1]{chapter5/HeatPlot.pdf}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \NormalTok{EXP_SMASH<-}\KeywordTok{merge}\NormalTok{(CyanosHeatPlot,CyanosSMASH,}\DataTypeTok{by.x=}\StringTok{"RastId"}\NormalTok{,}\DataTypeTok{by.y=}\StringTok{"RastIds"}\NormalTok{)}
  
  \NormalTok{EXP_SMASH2<-}\KeywordTok{merge}\NormalTok{(CyanosTaxa, EXP_SMASH, }\DataTypeTok{by.x=}\StringTok{"RastId"}\NormalTok{,}\DataTypeTok{by.y=}\StringTok{"RastId"}\NormalTok{) }
  
  \CommentTok{#qplot(Total.x, Total.y, data = EXP_SMASH, colour=Order)+theme_bw()+}
  \CommentTok{#}
  \NormalTok{sn<-}\KeywordTok{qplot}\NormalTok{(TOTAL.x, TOTAL.y, }\DataTypeTok{data =} \NormalTok{EXP_SMASH2,}\DataTypeTok{colour=}\NormalTok{Order)+}\KeywordTok{theme_bw}\NormalTok{()+}\KeywordTok{facet_grid}\NormalTok{(EXP_SMASH2$Order~.,}\DataTypeTok{scales=}\StringTok{"free"}\NormalTok{)+}\StringTok{ }
  \StringTok{        }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position   =}\StringTok{"bottom"}\NormalTok{,}\DataTypeTok{plot.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{14}\NormalTok{, }\DataTypeTok{face =} \StringTok{"bold"}\NormalTok{),}
                ...
                \DataTypeTok{axis.text.y=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{7}\NormalTok{))}
  \KeywordTok{ggsave}\NormalTok{(}\StringTok{"chapter5/SMASHvsExpansionsbyOrder.pdf"}\NormalTok{, }\DataTypeTok{plot =} \NormalTok{sn,}\DataTypeTok{height =} \DecValTok{12}\NormalTok{, }\DataTypeTok{width =} \DecValTok{6}\NormalTok{)}
  
  \NormalTok{## Looking for color modifications}
  \CommentTok{#sn + scale_color_brewer(palette="Dark2(100)")}
  \CommentTok{#n + scale_color_brewer(palette=hm.palette(10))}
  \NormalTok{## sn+ scale_color_hue(l=40, c=35)}
  \end{Highlighting}
  \end{Shaded}
  ...
  \begin{figure}[h!tbp]
  \centering
  \includegraphics[angle = 0,scale = 1]{chapter5/SMASHvsExpansionsbyOrder.pdf}
  ...
  Aqui una correlacion entre en talla de genoma y los productos de
  antismash Aqui una correlacion entre talla de genoma y expansiones
  ...
  \KeywordTok{qplot}\NormalTok{(TOTAL.x, TOTAL.y, }\DataTypeTok{data =} \NormalTok{EXP_SMASH2,}\DataTypeTok{colour=}\NormalTok{Family)+}\KeywordTok{theme_bw}\NormalTok{()+}\KeywordTok{facet_grid}\NormalTok{(EXP_SMASH2$Order~.,}\DataTypeTok{scales=}\StringTok{"free"}\NormalTok{)+}
  \StringTok{        }\KeywordTok{theme}\NormalTok{( }\DataTypeTok{plot.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{14}\NormalTok{, }\DataTypeTok{face =} \StringTok{"bold"}\NormalTok{),}
                \DataTypeTok{text =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{12}\NormalTok{),}
                \DataTypeTok{axis.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{face=}\StringTok{"bold"}\NormalTok{),}
                \DataTypeTok{axis.text.x=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{12}\NormalTok{),}
                \DataTypeTok{axis.text.y=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{7}\NormalTok{))}
  ...
  \begin{center}\includegraphics{tesis_files/figure-latex/ANTISMASH_Expansion_Correlation_by_orden_Cyanos-1} \end{center}
  
  \begin{Shaded}
  \begin{Highlighting}[]
  \CommentTok{#facet_grid(EXP_SMASH$Order~.,scales="free")+}
  \end{Highlighting}
  \end{Shaded}
  
  \section{Natural products
  recruitments}\label{natural-products-recruitments}
  
  We can see natural products origin by kingdom Natural products recruited
  by metabolic family, colored by phylogenetic origin.
  
  \begin{Shaded}
  \begin{Highlighting}[]
  \KeywordTok{qplot}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Central, }\DataTypeTok{data=}\NormalTok{CyanosNp, }\DataTypeTok{geom=}\StringTok{"bar"}\NormalTok{, }\DataTypeTok{fill=}\NormalTok{kingdom, }\DataTypeTok{position=}\StringTok{"stack"}\NormalTok{)+}\KeywordTok{theme_bw}\NormalTok{()+}\StringTok{ }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{text =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{8}\NormalTok{), }\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{90}\NormalTok{, }\DataTypeTok{hjust =} \DecValTok{1}\NormalTok{, }\DataTypeTok{vjust =} \FloatTok{0.5}\NormalTok{) ,}\DataTypeTok{axis.text.y =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{0}\NormalTok{, }\DataTypeTok{hjust =} \DecValTok{1}\NormalTok{, }\DataTypeTok{vjust =} \FloatTok{0.5}\NormalTok{) )}
  \end{Highlighting}
  \end{Shaded}
  ...
  \begin{center}\includegraphics{tesis_files/figure-latex/NP_recruitment_taxa_cyano-1} \end{center}
  
  \begin{Shaded}
  \begin{Highlighting}[]
  \KeywordTok{qplot}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Central, }\DataTypeTok{data=}\NormalTok{CyanosNp, }\DataTypeTok{geom=}\StringTok{"bar"}\NormalTok{, }\DataTypeTok{fill=}\NormalTok{taxa, }\DataTypeTok{position=}\StringTok{"stack"}\NormalTok{)+}\KeywordTok{theme_bw}\NormalTok{()+}\StringTok{ }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{text =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{8}\NormalTok{), }\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{90}\NormalTok{, }\DataTypeTok{hjust =} \DecValTok{1}\NormalTok{, }\DataTypeTok{vjust =} \FloatTok{0.5}\NormalTok{) ,}\DataTypeTok{axis.text.y =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{0}\NormalTok{, }\DataTypeTok{hjust =} \DecValTok{1}\NormalTok{, }\DataTypeTok{vjust =} \FloatTok{0.5}\NormalTok{) )}
  \end{Highlighting}
  \end{Shaded}
  ...
  \begin{center}\includegraphics{tesis_files/figure-latex/NP_recruitment_taxa_cyano-2} \end{center}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \NormalTok{## merge tables}
  \NormalTok{m1 <-}\StringTok{ }\KeywordTok{merge}\NormalTok{(CyanosTaxa, CyanosSMASH, }\DataTypeTok{by.x =} \StringTok{"RastId"}\NormalTok{, }\DataTypeTok{by.y =} \StringTok{"RastIds"}\NormalTok{)}
  \NormalTok{m1.m <-}\StringTok{ }\KeywordTok{melt}\NormalTok{(m1, }\DataTypeTok{id =} \KeywordTok{c}\NormalTok{(}\StringTok{"RastId"}\NormalTok{, }\StringTok{"Name"}\NormalTok{,}\StringTok{"Phylum"}\NormalTok{,}\StringTok{"Class"}\NormalTok{,}\StringTok{"Order"}\NormalTok{,}\StringTok{"Family"}\NormalTok{,}\StringTok{"Contigs"}\NormalTok{,}\StringTok{"Size"}\NormalTok{,}\StringTok{"RastNo"}\NormalTok{))}
  \NormalTok{m2.m<-}\KeywordTok{subset}\NormalTok{(m1.m,value>}\DecValTok{0}\NormalTok{)}
  
  
  \KeywordTok{qplot}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Order, }\DataTypeTok{data=}\NormalTok{m1.m, }\DataTypeTok{geom=}\StringTok{"bar"}\NormalTok{, }\DataTypeTok{fill=}\NormalTok{Family, }\DataTypeTok{position=}\StringTok{"stack"}\NormalTok{)+}\KeywordTok{theme_bw}\NormalTok{()+}\StringTok{ }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{text =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{8}\NormalTok{), }\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{90}\NormalTok{, }\DataTypeTok{hjust =} \DecValTok{1}\NormalTok{, }\DataTypeTok{vjust =} \FloatTok{0.5}\NormalTok{) ,}\DataTypeTok{axis.text.y =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{0}\NormalTok{, }\DataTypeTok{hjust =} \DecValTok{1}\NormalTok{, }\DataTypeTok{vjust =} \FloatTok{0.5}\NormalTok{) )}
  \end{Highlighting}
  \end{Shaded}
  ...
  \begin{center}\includegraphics{tesis_files/figure-latex/CyanoDiversity-1} \end{center}
  
  \begin{Shaded}
  \begin{Highlighting}[]
  \KeywordTok{table}\NormalTok{(m1.m$Order>}\DecValTok{0}\NormalTok{,m1.m$Family>}\DecValTok{0}\NormalTok{)}
  \end{Highlighting}
  \end{Shaded}
  
  \begin{verbatim}
  Warning in Ops.factor(m1.m$Order, 0): '>' not meaningful for factors
  \end{verbatim}
  
  \begin{verbatim}
  Warning in Ops.factor(m1.m$Family, 0): '>' not meaningful for factors
  \end{verbatim}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \CommentTok{#qplot(x=clarity, data=diamonds, geom="bar", fill=cut, position="stack")}
  
  \KeywordTok{qplot}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Order, }\DataTypeTok{data=}\NormalTok{m2.m, }\DataTypeTok{geom=}\StringTok{"bar"}\NormalTok{, }\DataTypeTok{fill=}\NormalTok{variable, }\DataTypeTok{position=}\StringTok{"stack"}\NormalTok{,}\DataTypeTok{colours =} \KeywordTok{hm.palette}\NormalTok{(}\DecValTok{100000}\NormalTok{))+}\KeywordTok{theme_bw}\NormalTok{()+}\StringTok{ }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position=}\StringTok{"none"}\NormalTok{,}\DataTypeTok{text =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{8}\NormalTok{), }\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{90}\NormalTok{, }\DataTypeTok{hjust =} \DecValTok{1}\NormalTok{, }\DataTypeTok{vjust =} \FloatTok{0.5}\NormalTok{) ,}\DataTypeTok{axis.text.y =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{0}\NormalTok{, }\DataTypeTok{hjust =} \DecValTok{1}\NormalTok{, }\DataTypeTok{vjust =} \FloatTok{0.5}\NormalTok{) )}
  \end{Highlighting}
  \end{Shaded}
  ...
  \begin{center}\includegraphics{tesis_files/figure-latex/CyanoDiversity-2} \end{center}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \CommentTok{#summary(CyanosHeatPlot.m)}
  \CommentTok{#table(CyanosHeatPlot.m$scale >=0,Deltas$DeltaPRO>=0)}
  \end{Highlighting}
  \end{Shaded}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \NormalTok{expansion_plot<-}\KeywordTok{ggplot}\NormalTok{(CyanosHeatPlot.m, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{CyanosHeatPlot.m$variable, }\DataTypeTok{y=}\NormalTok{CyanosHeatPlot.m$rescale)) +}\StringTok{ }\KeywordTok{geom_boxplot}\NormalTok{()+}\KeywordTok{theme_bw}\NormalTok{()+}\KeywordTok{theme}\NormalTok{(}\DataTypeTok{plot.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{14}\NormalTok{, }\DataTypeTok{face =} \StringTok{"bold"}\NormalTok{), }\DataTypeTok{text =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{12}\NormalTok{), }\DataTypeTok{axis.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{face=}\StringTok{"bold"}\NormalTok{), }\DataTypeTok{axis.text.x=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{90}\NormalTok{,}\DataTypeTok{size =} \DecValTok{6}\NormalTok{), }\DataTypeTok{legend.position =} \StringTok{"bottom"}\NormalTok{)}
  
  \CommentTok{#ggplot(CyanosHeatPlot.m, aes(x=CyanosHeatPlot.m$variable, y=CyanosHeatPlot.m$rescale)) + geom_boxplot()+theme_bw()+theme(plot.title = element_text(size = 14, face = "bold"), text = element_text(size = 12), axis.title = element_text(face="bold"), axis.text.x=element_text(angle = 90,size = 6), legend.position = "bottom")}
  \CommentTok{#+facet_grid(CyanosTaxa$class~.,scales="free")}
  \CommentTok{#ggplot(CyanosHeatPlot.m, aes(x=CyanosHeatPlot.m$variable,y=CyanosHeatPlot.m$rescale,fill=CyanosHeatPlot.m$rescale)) }
  \CommentTok{# +facet_grid(CyanosHeatPlot.m$rescale~.,scales="free")}
  
  \KeywordTok{ggsave}\NormalTok{(}\StringTok{"chapter5/expansion_plot.pdf"}\NormalTok{, }\DataTypeTok{plot =} \NormalTok{expansion_plot,}\DataTypeTok{height =} \DecValTok{6}\NormalTok{, }\DataTypeTok{width =} \DecValTok{7}\NormalTok{)}
  \end{Highlighting}
  \end{Shaded}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \KeywordTok{label}\NormalTok{(}\DataTypeTok{path =} \StringTok{"chapter5/expansion_plot.pdf"}\NormalTok{, }\DataTypeTok{caption =} \StringTok{"Expansions Boxplot"}\NormalTok{,}\DataTypeTok{label =} \StringTok{"Cyano_expansion_boxplot"}\NormalTok{, }\DataTypeTok{type =} \StringTok{"figure"}\NormalTok{)}
  \end{Highlighting}
  \end{Shaded}
  
  \begin{figure}[h!tbp]
  \centering
  \includegraphics[angle = 0,scale = 1]{chapter5/expansion_plot.pdf}
  \caption[Expansions Boxplot]{\normalsize{Expansions Boxplot}}
  \label{fig:Cyano_expansion_boxplot}
  \end{figure}
  
  \clearpage  Here is a reference to the expansion boxplot:
  \autoref{fig:Cyano_expansion_boxplot}.
  
  \section{Selected trees from
  EvoMining}\label{selected-trees-from-evomining}
  
  \section{Lets analize Phosphoribosyl\_isomerase\_3
  family}\label{lets-analize-phosphoribosyl_isomerase_3-family}
  
  Figure from EvoMining \clearpage 
  ...
  Zotero. The Reed librarians have created Zotero documentation at
  \url{http://libguides.reed.edu/citation/zotero}. In addition, a tutorial
  is available from Middlebury College at
  \url{http://sites.middlebury.edu/zoteromiddlebury/}.
