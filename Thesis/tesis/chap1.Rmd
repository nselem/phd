...
label(path = "chapter1/Clavisual.png",
      scale=".4", 
      caption = " X X XXXX",
...
Tomando otros siete clavibacters, utilizando OrthoVenn tenemos la misma observación, el número de familias de genes agregadas al adicionar genomas, es después de siete genomas casi tan grande como su core `r ref(label = "Venn-Chart", type = "figure")`. 
```{r Venn-pangenoma, results = "asis",message=FALSE,echo=FALSE}
label(path = "chapter1/Venn_chart.pdf",
      scale=".6", 
      caption = " X X",
      alt.cap = "Diagrama de Venn del pangenoma de Clavibacter Selectos",
      cap.size = "footnotesize",
      label = "Venn-Chart", 
      type = "figure")
```
...
Table: Variantes de formatos genpomicos Orthochore \label{tab:inher}
  Referencia `r ref("inher", type = "table")`.  
