...
label(path = "chapter1/Clavisual.pdf",
      scale=".7", 
      caption = "Clavisual organiza filogenéticamente cepas de $Clavibacter$ ",
      alt.cap = "Aqui vemos un arbol",
      cap.size = "footnotesize",
      label = "Clavisual", 
      type = "figure")
```
...
label(path = "chapter1/bpga-pangenoma.png",
      scale=".5", 
      caption = " X X",
      alt.cap = "Pangenoma de $Clavibacter$ calculado por BPGA ",
      cap.size = "footnotesize",
...
label(path = "chapter1/Venn_chart.pdf",
      ...
      alt.cap = "Diagrama de Venn del pangenoma de genomas selectos del género $Clavibacter$ ",
      cap.size = "footnotesize",
      label = "Venn-Chart", 
      type = "figure")
```
