...
<!---
  ...
  Enrique Salmonella  
  --->
# Orthocore: encontrando el core conservado en un linaje taxonómico.      
Orthocore es un desarrollo bioinformático que realicé para calcular las familias enzimáticas más conservadas pertenecientes al core genome de un conjunto de genomas. Orthocore obtiene el core conservado es decir familias de ortólogos presentes en todos los genomas del grupo, libres de parálogos e independientes de un genoma de referencia. 
