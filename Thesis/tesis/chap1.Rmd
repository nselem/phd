...
El pangenoma es el contenido génico total de un linaje taxonómico. Las familias génicas de un pangenoma pueden clasificarse según sus patrones de presencia-ausencia en cada genoma del linaje. De acuerdo a esta clasificación los principales grupos de familias génicas en un pangenoma son el _core_, el _shell_ y el _cloud_ (dispensable) genome. El _core genome_ es el conjunto de familias con presencia en todos los genomas del linaje. Por ejemplo, la secuencia de la subunidad 16s de rRNA, así como diversos genes ribosomales suelen estar en el core de la gran mayoría de los linajes bacterianos. El _shell genome_ es el grupo de familias presentes en la mayoría de los genomas pero no en todos. En el _shell_ se ubican por ejemplo familias que estaban en el _core genome_ pero que algunas bacterias del linaje sufrieron una dinámica de pérdida (o ganancia) génica. Mientras que el _cloud genome_ o dispensable genome es aquel grupo de familias que sólo ocurre en unos cuantos genomas del linaje.  
