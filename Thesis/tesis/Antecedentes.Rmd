...
3 Nobeli familias de enzimas [@nobeli_protein_2009]
4 Estudio de familias  koonin ?? Core / Pangenome 
5 Genomica y promiscuidad. 
El genoma bacteriano 
Promiscuidad en el pangenoma .. Pangenoma por exploracion,  
...
En extra copias por neofuncionalizacion. [@schniete_expanding_2018, @verdel-aranda_molecular_2015]
...
El estudio del metabolismo puede abordarse a varios niveles: genes, enzimas, familias enzimáticas, rutas metabólicas, organismos e inclusive comunidades. De la misma forma si se entiende la promiscuidad como funciones metabólicas alternativas puede observarse promiscuidad a distintos niveles, desde un mismo gen que presenta splicing alternativo . la variación es la materia prima de la evolucion. la promiscuidad enzimática podemos estudiarla en esos mismos. tres de ellos son: i) en una enzima de un organismo en particular, ii) en una familia de enzimas homólogas iii) en rutas de metabolismo especializado. En este trabajo se discierne entre las preguntas ¿es esta familia promiscua?, ¿Dentro de esta familia promiscua, es promiscua la enzima perteneciente a este organismo?, ¿Es este cluster biosintético promiscuo?. El primer problema consiste en ubicar cuáles familias enzimáticas tienen al menos una enzima promiscua, esta  es una propiedad de las familias. El segundo problema consiste en identifcar individualmente enzimas promiscuas en una familia promiscuas, esta es una propiedad de las enzimas  no de las familias. Y finalmente si entendemos un cluster biosintético como un conjunto de enzimas que reciben un sustrato, podemos generalizar la noción de promiscuidad a rutas biosintéticas de metabolismo especializado.  
...
2  Estructuras flexibles   [@zou_evolution_2015, ]
3  E life contexto genomico  []
4  pangenome promiscuity  ??? []
5  Tesis Lianet in vivo in vitro []
--->
...
1 String 
2 RAST  
3 clusterblast  bases privadas Archaeas 
4 AntiSMASH  
5 Cluster Finder  
--->
...
<!--- PriA  
Investigacion otros taxa de Investigacion en Actinos  
Variacion residuos  Tesis Lia pendiente analizar rutas  
Docking estrategias moleculares Lia articulo  
Ernesto articulo  GTP  
--->
