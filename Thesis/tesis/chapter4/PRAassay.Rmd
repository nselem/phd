...
AAdata["TrpF"]<-TrpF_vol ## muy activa en este caso recordad concentracion distinta a la hora de michaelis
AAdata["TrpC"]<-TrpC
AAdata["TrpD"]<-TrpD
...
With TrpC final `r TrpC_final` $\mu M$ TrpD final `r TrpD_final` $\mu M$ TrpF final `r TrpF_final` $\mu M$ 
