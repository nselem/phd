...
```{r load_pkgs_TrpFkinetics,  message=FALSE,echo=FALSE,warning=FALSE}
...
```
<!-- Comentado para la tesis porque no son necesarias las pendientes
## Gráfico de pendientes   -->
```{r slopes,  message=FALSE,echo=FALSE,warning=FALSE,eval=FALSE}
...
<!-- Comentado para la tesis porque no funcionó la libreria de michaelis para esta version de R
## Interpolación con Michaelis Menden  -->
```{r interpolar michaelis-menden, eval=FALSE, message=FALSE,echo=FALSE,warning=FALSE}
