...
plot(AA_mean, Fluor_mean,ylab="UAR",xlab="PRA uM", pch=19)
par(new=TRUE)
...
slopes=(round(V0[-1],digits=6))[c(TRUE,FALSE)]
concentration<-as.matrix(PRAassay2Time[1,names(slopes)])
#slopes
#concentration
slopes=as.matrix((round(V0[-1],digits=6))[c(TRUE,FALSE)])
...
## plot on r base
plot(mm,log='',xlim=c(-0.1,210), ylim=c(-0.01,.01), xlab="Reads", ylab="Transcripts")
