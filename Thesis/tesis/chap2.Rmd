...
## Enzymes  
39 Streptomyces PriA sequences has differences on PriA funcion. PriA 
1.Phylogenetic Tree
...
as an outgroup with HisA activity Enterobacterias _Salmonella enterica_ (PDB:5AHE), _Escherichia coli K12_
...
S13,S14,!5,S16 light activated substrates, S3 PRA, S7 PROFAR, S6 GMP, S11 GTP, S17 PRAP, S18 Compound V, S17 PraP
...
```{r Chemical_table_out, results = "asis"}
chemical <- read.csv("chapter2/chemical.data.csv", row.names = 1,sep="\t")
kable(chemical,  caption = "PriA enzymatic kinetics \\label{tab:chemical}",caption.short = "PriA Kinetics ")
```
