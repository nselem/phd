...
En la siguiente sección se analizarán los patrones de expansión reclutamiento de GDH provistas por EvoMining for GDH y se describirán los árboles filogenéticos de cada linaje mostrados en la `r ref(label = "GenomicLinajes, type = "figure")` , así como un árbol que incluye conjuntamente secuencias de todos los linajes (Data 4 and Figs S12 and S13). En Archaea, GDH tiene en promedio 1.23 copias por genoma, mientras en Actinobacteria, Cyanobacteria y Pseudomonas esta media es de 0.74, 0.56 y 0.65, respectivamente. En estos tres taxa GDH es parte del shell genome (Table S2).  
...
La familia GDH muestra expansiones aunque no muy abundantes en Actinobacteria [Data 5] `r ref(label = "GenomicLinajes, type = "figure")` panel (a) ,y en Cyanobacteria [Data 6] `r ref(label = "GenomicLinajes, type = "figure")` panel(b). Las expansiones están prácticamente ausentes en Pseudomonas [Data 7] `r ref(label = "GenomicLinajes, type = "figure")` panel (c). En contraste, un número significativo de expansiones es encontrado en Archaea [Data 8] `r ref(label = "GenomicLinajes, type = "figure")` panel(d) . El árbol de EvoMining de la familia GDH en Archaea fue enraizado con la secuencia semilla de _Sulfolobus, que fue predicha por RAST como una enzima dual en el uso de cofactores NAD(P)+[@consalvi_glutamate_1991]. En Archaea las tres clases de GDH alternan en las ramas del árbol (Fig. S13, Data 5-8).  
...
Al generar el árbol de EvoMining de ALS en Cyanobacteria (Fig. S11 and Data 9), se observó que _scyA_ es un reclutamiento que se localiza en una rama repleta de secuencias de ALS provenientes de _Nostoc spp._, que fueron etiquetadas como predicciones de EvoMining   `r ref(label = "Scytonemin", type = "figure")`      (c). Estas predicciones incluyen más de veinte organismos conocidos como productores de scytonemin [@balskus_investigating_2008]
...
|No |MIBiG    BGC  |Compound        |Class |Producer Organism   |  
|---|--------------|----------------|------|--------------------|  
|1  |653_ADO85576|pentalenolactone|Terpene| _Streptomyces arenae_ |  
|2  |678_BAC70706|pentalenolactone|Terpene| _Streptomyces avermitilis_ NBRC 14893|  
|3  |163_ACR50790|tetronasin      |Polyketide| _Streptomyces longisporoflavus_|  
|4  |961_ABC36162 |bactobolin      |NRP-Polyketide| _Burkholderia thailandensis_ E264 |   
|5  |287_AAG05698|2-amino-4-methoxy-trans-3-butenoic acid|NRP| _Pseudomonas aeruginosa_ PAO1|  
|6  |846_ctg1_orf9|tabtoxin|      Other| _Pseudomonas syringae_|  
|7  |1183_AGC09526|lobophorin|Polyketide| _Streptomyces sp. FXJ7.023_|  
|8  |1156_ADD83004|platencin|Terpene| _Streptomyces platensis_|  
|9  |1140_ACO31277|platensimycin- platencin|Terpene| _Streptomyces platensis_ |  
|10 |1140_ACO31282|platensimycin- platencin|Terpene| _Streptomyces platensis_ |  
|11 |715_ABW87795|spectinomycin|Saccharide| _Streptomyces spectabilis_ |  
|12 |1205_KGO40485|communesin|Polyketide| _Penicillium expansum_ |  
|13 |1205_KGO40482|communesin|Polyketide| _Penicillium expansum_ |  
|14 |1183_AGC09525|lobophorin|Polyketide| _Streptomyces_ sp. FXJ7.023 |  	
|15 |654_ABB69741|phenalinolactone|Saccharide-Terpene| _Streptomyces_ sp. Tu6071 |  
|16 |1070_CAN89617|kirromycin|NRP - Polyketide| _Streptomyces collinus_ Tu 365|  
