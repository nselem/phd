...
label(path = "chapter3/corason_fig1.png", caption = "EvoMining Algorithm",label = "EvoMining Algorithms", type = "figure")
```


```{r EvoMiningAlgorithm2, results = "asis",message=FALSE,echo=FALSE}
label(path = "chapter3/figura5.pdf", caption = "EvoMining Algorithm",label = "EvoMining Algorithms", type = "figure")
```


```{r EvoMiningAlgorithm3, results = "asis",message=FALSE,echo=FALSE}
label(path = "chapter3/Coelicolor.png", caption = "EvoMining Algorithm",label = "EvoMining Algorithms", type = "figure")
```
